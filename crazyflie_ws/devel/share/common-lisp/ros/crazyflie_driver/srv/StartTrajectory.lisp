...
(cl:defmethod cl:initialize-instance :after ((m <StartTrajectory-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StartTrajectory-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crazyflie_driver-srv:<StartTrajectory-request> is deprecated: use crazyflie_driver-srv:StartTrajectory-request instead.")))
...
(cl:defmethod timescale-val ((m <StartTrajectory-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_driver-srv:timescale-val is deprecated.  Use crazyflie_driver-srv:timescale instead.")
  (timescale m))

(cl:ensure-generic-function 'reversed-val :lambda-list '(m))
(cl:defmethod reversed-val ((m <StartTrajectory-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_driver-srv:reversed-val is deprecated.  Use crazyflie_driver-srv:reversed instead.")
  (reversed m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<StartTrajectory-request>)))
  ...
  "crazyflie_driver/StartTrajectoryRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'StartTrajectory-request)))
  "Returns string type for a service object of type 'StartTrajectory-request"
  "crazyflie_driver/StartTrajectoryRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <StartTrajectory-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StartTrajectory-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crazyflie_driver-srv:<StartTrajectory-response> is deprecated: use crazyflie_driver-srv:StartTrajectory-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<StartTrajectory-response>)))
  ...
  "crazyflie_driver/StartTrajectoryResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'StartTrajectory-response)))
  "Returns string type for a service object of type 'StartTrajectory-response"
  "crazyflie_driver/StartTrajectoryResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'StartTrajectory)))
  ...
  "crazyflie_driver/StartTrajectory")