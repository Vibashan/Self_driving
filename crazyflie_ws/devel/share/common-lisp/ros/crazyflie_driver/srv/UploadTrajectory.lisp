...
(cl:defclass <UploadTrajectory-request> (roslisp-msg-protocol:ros-message)
  ((trajectoryId
   ...
   (pieces
    :reader pieces
    :initarg :pieces
    :type (cl:vector crazyflie_driver-msg:TrajectoryPolynomialPiece)
   :initform (cl:make-array 0 :element-type 'crazyflie_driver-msg:TrajectoryPolynomialPiece :initial-element (cl:make-instance 'crazyflie_driver-msg:TrajectoryPolynomialPiece))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <UploadTrajectory-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'UploadTrajectory-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crazyflie_driver-srv:<UploadTrajectory-request> is deprecated: use crazyflie_driver-srv:UploadTrajectory-request instead.")))

(cl:ensure-generic-function 'trajectoryId-val :lambda-list '(m))
(cl:defmethod trajectoryId-val ((m <UploadTrajectory-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_driver-srv:trajectoryId-val is deprecated.  Use crazyflie_driver-srv:trajectoryId instead.")
  (trajectoryId m))

(cl:ensure-generic-function 'pieceOffset-val :lambda-list '(m))
(cl:defmethod pieceOffset-val ((m <UploadTrajectory-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_driver-srv:pieceOffset-val is deprecated.  Use crazyflie_driver-srv:pieceOffset instead.")
  (pieceOffset m))

(cl:ensure-generic-function 'pieces-val :lambda-list '(m))
(cl:defmethod pieces-val ((m <UploadTrajectory-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_driver-srv:pieces-val is deprecated.  Use crazyflie_driver-srv:pieces instead.")
  (pieces m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <UploadTrajectory-request>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'pieces)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'crazyflie_driver-msg:TrajectoryPolynomialPiece))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<UploadTrajectory-request>)))
  ...
  "crazyflie_driver/UploadTrajectoryRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'UploadTrajectory-request)))
  "Returns string type for a service object of type 'UploadTrajectory-request"
  "crazyflie_driver/UploadTrajectoryRequest")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<UploadTrajectory-request>)))
  ...
  (cl:format cl:nil "uint8 trajectoryId~%uint32 pieceOffset~%TrajectoryPolynomialPiece[] pieces~%~%================================================================================~%MSG: crazyflie_driver/TrajectoryPolynomialPiece~%#~%~%float32[] poly_x~%float32[] poly_y~%float32[] poly_z~%float32[] poly_yaw~%duration duration~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'UploadTrajectory-request)))
  "Returns full string definition for message of type 'UploadTrajectory-request"
  (cl:format cl:nil "uint8 trajectoryId~%uint32 pieceOffset~%TrajectoryPolynomialPiece[] pieces~%~%================================================================================~%MSG: crazyflie_driver/TrajectoryPolynomialPiece~%#~%~%float32[] poly_x~%float32[] poly_y~%float32[] poly_z~%float32[] poly_yaw~%duration duration~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <UploadTrajectory-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'UploadTrajectory-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crazyflie_driver-srv:<UploadTrajectory-response> is deprecated: use crazyflie_driver-srv:UploadTrajectory-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<UploadTrajectory-response>)))
  ...
  "crazyflie_driver/UploadTrajectoryResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'UploadTrajectory-response)))
  "Returns string type for a service object of type 'UploadTrajectory-response"
  "crazyflie_driver/UploadTrajectoryResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'UploadTrajectory)))
  ...
  "crazyflie_driver/UploadTrajectory")