...
(cl:defmethod cl:initialize-instance :after ((m <GoTo-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GoTo-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crazyflie_driver-srv:<GoTo-request> is deprecated: use crazyflie_driver-srv:GoTo-request instead.")))

(cl:ensure-generic-function 'groupMask-val :lambda-list '(m))
(cl:defmethod groupMask-val ((m <GoTo-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_driver-srv:groupMask-val is deprecated.  Use crazyflie_driver-srv:groupMask instead.")
  (groupMask m))

(cl:ensure-generic-function 'relative-val :lambda-list '(m))
(cl:defmethod relative-val ((m <GoTo-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_driver-srv:relative-val is deprecated.  Use crazyflie_driver-srv:relative instead.")
  (relative m))

(cl:ensure-generic-function 'goal-val :lambda-list '(m))
(cl:defmethod goal-val ((m <GoTo-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_driver-srv:goal-val is deprecated.  Use crazyflie_driver-srv:goal instead.")
  (goal m))

(cl:ensure-generic-function 'yaw-val :lambda-list '(m))
(cl:defmethod yaw-val ((m <GoTo-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_driver-srv:yaw-val is deprecated.  Use crazyflie_driver-srv:yaw instead.")
  (yaw m))

(cl:ensure-generic-function 'duration-val :lambda-list '(m))
(cl:defmethod duration-val ((m <GoTo-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_driver-srv:duration-val is deprecated.  Use crazyflie_driver-srv:duration instead.")
  (duration m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GoTo-request>)))
  ...
  (cl:format cl:nil "uint8 groupMask~%bool relative~%geometry_msgs/Point goal~%float32 yaw~%duration duration~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GoTo-request)))
  "Returns full string definition for message of type 'GoTo-request"
  (cl:format cl:nil "uint8 groupMask~%bool relative~%geometry_msgs/Point goal~%float32 yaw~%duration duration~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <GoTo-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GoTo-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crazyflie_driver-srv:<GoTo-response> is deprecated: use crazyflie_driver-srv:GoTo-response instead.")))
