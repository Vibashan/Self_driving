...
(cl:defmethod cl:initialize-instance :after ((m <Takeoff-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Takeoff-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crazyflie_driver-srv:<Takeoff-request> is deprecated: use crazyflie_driver-srv:Takeoff-request instead.")))
...
(cl:defmethod height-val ((m <Takeoff-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_driver-srv:height-val is deprecated.  Use crazyflie_driver-srv:height instead.")
  (height m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Takeoff-request>)))
  ...
  "crazyflie_driver/TakeoffRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Takeoff-request)))
  "Returns string type for a service object of type 'Takeoff-request"
  "crazyflie_driver/TakeoffRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <Takeoff-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Takeoff-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crazyflie_driver-srv:<Takeoff-response> is deprecated: use crazyflie_driver-srv:Takeoff-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Takeoff-response>)))
  ...
  "crazyflie_driver/TakeoffResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Takeoff-response)))
  "Returns string type for a service object of type 'Takeoff-response"
  "crazyflie_driver/TakeoffResponse")
