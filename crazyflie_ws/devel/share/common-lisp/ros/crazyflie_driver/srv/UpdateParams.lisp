...
(cl:defmethod cl:initialize-instance :after ((m <UpdateParams-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'UpdateParams-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crazyflie_driver-srv:<UpdateParams-request> is deprecated: use crazyflie_driver-srv:UpdateParams-request instead.")))

(cl:ensure-generic-function 'params-val :lambda-list '(m))
(cl:defmethod params-val ((m <UpdateParams-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_driver-srv:params-val is deprecated.  Use crazyflie_driver-srv:params instead.")
  (params m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<UpdateParams-request>)))
  ...
  "crazyflie_driver/UpdateParamsRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'UpdateParams-request)))
  "Returns string type for a service object of type 'UpdateParams-request"
  "crazyflie_driver/UpdateParamsRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <UpdateParams-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'UpdateParams-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crazyflie_driver-srv:<UpdateParams-response> is deprecated: use crazyflie_driver-srv:UpdateParams-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<UpdateParams-response>)))
  ...
  "crazyflie_driver/UpdateParamsResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'UpdateParams-response)))
  "Returns string type for a service object of type 'UpdateParams-response"
  "crazyflie_driver/UpdateParamsResponse")
