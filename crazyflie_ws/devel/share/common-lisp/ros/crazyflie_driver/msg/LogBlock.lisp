...
(cl:defmethod cl:initialize-instance :after ((m <LogBlock>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LogBlock)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crazyflie_driver-msg:<LogBlock> is deprecated: use crazyflie_driver-msg:LogBlock instead.")))

(cl:ensure-generic-function 'topic_name-val :lambda-list '(m))
(cl:defmethod topic_name-val ((m <LogBlock>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_driver-msg:topic_name-val is deprecated.  Use crazyflie_driver-msg:topic_name instead.")
  (topic_name m))

(cl:ensure-generic-function 'frequency-val :lambda-list '(m))
(cl:defmethod frequency-val ((m <LogBlock>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_driver-msg:frequency-val is deprecated.  Use crazyflie_driver-msg:frequency instead.")
  (frequency m))

(cl:ensure-generic-function 'variables-val :lambda-list '(m))
(cl:defmethod variables-val ((m <LogBlock>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_driver-msg:variables-val is deprecated.  Use crazyflie_driver-msg:variables instead.")
  (variables m))
