...
(cl:defmethod cl:initialize-instance :after ((m <FullState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FullState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crazyflie_driver-msg:<FullState> is deprecated: use crazyflie_driver-msg:FullState instead.")))
...
(cl:defmethod pose-val ((m <FullState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_driver-msg:pose-val is deprecated.  Use crazyflie_driver-msg:pose instead.")
  (pose m))

(cl:ensure-generic-function 'twist-val :lambda-list '(m))
(cl:defmethod twist-val ((m <FullState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_driver-msg:twist-val is deprecated.  Use crazyflie_driver-msg:twist instead.")
  (twist m))

(cl:ensure-generic-function 'acc-val :lambda-list '(m))
(cl:defmethod acc-val ((m <FullState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_driver-msg:acc-val is deprecated.  Use crazyflie_driver-msg:acc instead.")
  (acc m))
