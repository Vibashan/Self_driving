...
"""autogenerated by genpy from crazyflie_driver/UploadTrajectoryRequest.msg. Do not edit."""
import sys
...
class UploadTrajectoryRequest(genpy.Message):
  ...
  _type = "crazyflie_driver/UploadTrajectoryRequest"
...
duration duration"""
  ...
  _slot_types = ['uint8','uint32','crazyflie_driver/TrajectoryPolynomialPiece[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = crazyflie_driver.msg.TrajectoryPolynomialPiece()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sf'%length
...
def _get_struct_2i():
    ...
    return _struct_2i
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from crazyflie_driver/UploadTrajectoryResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class UploadTrajectoryResponse(genpy.Message):
  ...
  _type = "crazyflie_driver/UploadTrajectoryResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """
"""
  __slots__ = []
...
class UploadTrajectory(object):
  _type          = 'crazyflie_driver/UploadTrajectory'
  _md5sum = 'becd7733dfdc3d0c93a9064ba651cf17'
